...
import {animateScaleInZoom} from '@/libs/animation';

function BrideGroom({data}: any) {
  return (
    <div className="relative w-full overflow-hidden flex items-center flex-col bg-white">
      <motion.div className="w-[65%] border-[3px] h-[230px] rounded-b-full border-[#D4AF37] mt-[-10px] flex items-center justify-center" {...animateScaleInZoom}>
        <p className="text-zinc-500">THE BRIDE</p>
      </motion.div>
      <motion.div className="flex w-full justify-center flex-col items-center mt-[-80px] mb-14" {...animateScaleInZoom}>
        <Image
      ...
      <motion.div className="w-[65%] border-[3px] h-[250px] rounded-full border-[#D4AF37] mt-[-10px] flex items-center justify-center" {...animateScaleInZoom}>
